...
$value = $data['booking'];
// ^$ = anchors, (ABC|ACD|BCD) = matches ABC or ACD or BCD, \- = one - symbol, (5|8) = matches 5 or 8,  [0-9]{4} = 4 digits
$format = "/^(ABC|ACD|BCD)\-(5|8)[0-9]{4}$/";
// If value does NOT match the format then it is invalid
if (!preg_match($format, $value)) {
    $feedback['booking'] = 'Server feedback: The booking reference is invalid';
    $valid = false;
}
