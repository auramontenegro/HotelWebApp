...
function validate(inputElement) {
    ...
    if (inputElement.id == "booking") {
        // ^$ = anchors, [a-zA-Z]{3} = 3 letters, \- = one - symbol, [0-9]{5} = 5 digits
        pattern = /^[a-zA-Z]{3}\-[0-9]{5}$/;
        feedback = "Only 3 letters and a hyphen followed by 5 digits";
    }
...
function validateForm() {
    ...
    valid = valid && validate(document.getElementById("booking"));
